"""
Pull open ShipStation orders into data/open_orders.json.
...
PAGE_SIZE = 500
OUT = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "data", "open_orders.json")
...
def main():
    ...
    print(f"Saved {len(orders_seen)} orders / {len(lines)} lines to data/open_orders.json")
